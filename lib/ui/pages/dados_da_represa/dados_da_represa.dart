import 'package:auto_depura/ui/pages/dados_da_represa/steps/dados_da_represa_step1.dart';
...
class DadosDaRepresaPage extends StatefulWidget {
  const DadosDaRepresaPage({super.key});

  @override
  State<DadosDaRepresaPage> createState() => _DadosDaRepresaPageState();
}

class _DadosDaRepresaPageState extends State<DadosDaRepresaPage> {
  int index = 0;
        ...
        child: ListView(
          ...
          children: [
            ...
            IndexedStack(
              index: index,
              children: [
                DadosRepresaStep1(onPressed: onPressed),
              ],
            ),
